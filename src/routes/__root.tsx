  ...
  head: () => ({
    meta: [
      ...
      { title: "RateSphere — Discover. Rate. Trust." },
      {
        name: "description",
        content:
          "RateSphere is a store rating platform where shoppers discover stores, share honest 1–5 ratings, and owners track their reputation.",
      },
      { property: "og:title", content: "RateSphere — Discover. Rate. Trust." },
      {
        property: "og:description",
        content: "Discover stores, share honest ratings, and build trust with real feedback.",
      },
